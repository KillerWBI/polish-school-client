...
const STEPS = [
  { sel: '[data-tour="quickstart"]', place: 'bottom', title: 'Быстрый старт',      text: 'Чеклист запуска кабинета: создайте группу, добавьте ученика и задайте домашнее задание. Галочки проставляются сами.' },
  { sel: '[data-tour="kpi"]',        place: 'bottom', title: 'Ключевые метрики',   text: 'Уроки на сегодня, задания без проверки, долги и посещаемость. Клик по карточке ведёт в раздел.' },
