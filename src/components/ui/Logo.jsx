...
// Бирюзовая плитка + белый знак — читается на любом фоне и в маленьком размере.
// id градиента делаем уникальным на каждый экземпляр, чтобы не конфликтовали на одной странице.
let uid = 0
export default function Logo({ size = 28, className = '' }) {
  const gid = `dk-${++uid}`
  return (
    <svg width={size} height={size} viewBox="0 0 60 60" className={className} role="img" aria-label="Peravenor">
      <defs>
        <linearGradient id={gid} x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#38C2BF" />
          <stop offset="1" stopColor="#1E9391" />
        </linearGradient>
      </defs>
      ...
      <path d="M30 15 C30.9 21 31.9 22 38.5 23.5 C31.9 25 30.9 26 30 32 C29.1 26 28.1 25 21.5 23.5 C28.1 22 29.1 21 30 15 Z" fill="#1E9391" />
