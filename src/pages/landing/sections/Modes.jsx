        ...
        <div className="mt-14 grid lg:grid-cols-[1fr_auto_1fr] gap-8 items-stretch">
          ...
          <div className="rounded-2xl border border-[#1E1E22] bg-[#0A0A0B] p-7">
            ...
            <div className="mt-5 space-y-2 font-mono text-[12px] text-[#8A8A8F]">
              <div className="flex items-center gap-2"><span className="text-[#3A3A40]">01</span> {t('modes.a1')}</div>
              <div className="flex items-center gap-2"><span className="text-[#3A3A40]">02</span> {t('modes.a2')}</div>
              <div className="flex items-center gap-2"><span className="text-[#3A3A40]">03</span> {t('modes.a3')}</div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-brand-600/30 bg-gradient-to-br from-[#0A0A0B] to-[#12101A] p-7">
            ...
            <div className="mt-5 space-y-2 font-mono text-[12px] text-[#8A8A8F]">
              <div className="flex items-center gap-2"><span className="text-[#3A3A40]">01</span> {t('modes.b1')}</div>
              <div className="flex items-center gap-2"><span className="text-[#3A3A40]">02</span> {t('modes.b2')}</div>
