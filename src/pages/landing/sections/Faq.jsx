...
export default function Faq() {
  ...
  return (
    <section id="faq" className="bg-[#18181C] text-[#EDEDED] border-t border-[#26262B]">
      <div className="max-w-3xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
        ...
        <div className="divide-y divide-[#303036] border-y border-[#303036]">
          {ITEMS.map((it, i) => {
            const isOpen = open === i
            return (
              <div key={i}>
                ...
                >
                  <span className="flex gap-3">
                    <span className="font-mono text-[12px] text-[#48484F] mt-0.5">{String(i + 1).padStart(2, '0')}</span>
        ...
        <div className="mt-10 rounded-xl border border-[#303036] bg-[#1D1D22] p-5 flex items-center gap-3">
