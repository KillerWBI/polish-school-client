  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        actions={loading && (
          <div className="w-5 h-5 rounded-full border-2 border-slate-200 border-t-teal-500 animate-spin" />
        )}
      />
    ...
    <div className="p-6">
      ...
      {linkUrl && (
        <a
          ...
          className="flex items-center justify-center gap-2 w-full h-10 rounded-xl bg-teal-500 hover:bg-teal-600 text-white text-sm font-medium transition-colors"
        >
