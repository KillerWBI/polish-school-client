...
| TopicsPage (самостоятельные темы + адаптивные AI-тесты, EMA-обладание) | `/topics` | ✅ | ✅ Lazy |
...
- [ ] **Учебные треки** — адаптивное самообучение (роадмап+практика+разбор+обладание). Полная спец: `LEARNING-TRACKS.md`
